<?php
   ...
   ?>
			...
			<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
				...
				<div class="d-flex align-items-center flex-wrap mr-1">
					...
					<div class="d-flex align-items-baseline flex-wrap mr-5">
						<!--begin::Page Title-->
						<h5 class="text-dark font-weight-bold my-1 mr-5">Nạp Tiền Từ Ngân Hàng Liên Kết</h5>
						<!--end::Page Title-->
						<!--begin::Breadcrumb-->
				...
				<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
                  ...
                  <!--end::Svg Icon-->
					...
					<div class="alert-text">
						<p> <code>Nếu không hiểu</code> vui lòng inbox <a href="//dtsr11.com">ADMIN</a> để được hỗ trợ tốt nhất! </p>
				...
				<div class="card card-custom">
					...
					<div class="card-header card-header-tabs-line">
						<ul class="nav nav-dark nav-bold nav-tabs nav-tabs-line" data-remember-tab="tab_id" role="tablist">
							<li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#MomoSend">Nạp Tiền Từ Ngân Hàng Liên Kết</a> </li>
						</ul>
					</div>
					<!--end::Header-->
					<!--begin::Form-->
						...
						<div class="card-body">
							<div class="form-group row ">
                              ...
                              ?>
									...
									<div class="valid-feedback">Vui lòng chọn số điện thoại MoMo cần nạp tiền.</div>
								</div>
							</div>
							<div class="form-group row ">
								<label class="col-form-label col-lg-3">Chọn Ngân Hàng: <span class="text-danger">*</span> </label>
								<div class="col-lg-9">
									<select class="form-control is-valid" name="bankname" id="bankname">
									...
									<option value="OCB">OCEANBANK</option>
							...
							<div class="form-group row ">
								...
								<div class="col-lg-9">
									...
									<div class="valid-feedback">Vui lòng nhập số tiền cần nạp,nhỏ nhất 50k.</div>
								</div>
							</div>
	...
	<!--begin::Page Scripts(used by this page)-->
		<script src="/assets/js/pages/crud/ktdatatable/base/topup.js?v=<?=rand()?>"></script>
	<!--end::Page Scripts-->
	<script>
